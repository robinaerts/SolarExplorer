...
const char *ssid = "SolarExplorer";
const char *password = "expl0re";
...
<html lang="en">
  <head>
    ...
    <script
      src="https://kit.fontawesome.com/32d11d6244.js"
  ...
  <body>
    <div id="container">
      <img id="cam-view" alt="stream" src="" />
      <div class="controls">
        <div id="motion">
          <button
            class="move-button"
    ...
    <script>
      const webSocketCameraUrl =
        "ws:\/\/" + window.location.hostname + "/Camera";
      const webSocketCarInputUrl =
      ...
      function initCameraWebSocket() {
        ...
        websocketCamera.onmessage = function (event) {
          const imageId = document.getElementById("cam-view");
...
<!DOCTYPE html>
    ...
    <title> Besturing</ title>
    <script
         src = "https://kit.fontawesome.com/32d11d6244.js" crossorigin = "anonymous"></ script>
    <style>
        *
{
margin:
